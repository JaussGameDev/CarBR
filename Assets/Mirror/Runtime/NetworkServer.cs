...
namespace Mirror
{
    ...
    public static class NetworkServer
    {
        ...
        {
            Debug.Log("00/04 NetworkServer.SpawnObject : Start | obj : " + obj.name);
            if (!active)
            {
            ...
            {
                Debug.Log("01/04 NetworkServer.SpawnObject : if SpawnedFromInstantiate | obj : " + obj.name);
            ...
            Debug.Log("02/04 NetworkServer.SpawnObject : if after | obj : " + obj.name);
            ...
            Debug.Log("03/04 NetworkServer.SpawnObject : before Identity.OnStartServer | obj : " + obj.name);
            identity.OnStartServer();

            if (logger.LogEnabled()) logger.Log("SpawnObject instance ID " + identity.netId + " asset ID " + identity.assetId);

            Debug.Log("04/05 NetworkServer.SpawnObject : before Identity.RebuildObservers(true) | obj : " + obj.name);
            identity.RebuildObservers(true);

            Debug.Log("05/05 NetworkServer.SpawnObject : End | obj : " + obj.name);
        }
        ...
        {
            Debug.Log("01/03 NetworkServer.Spawn : start | obj :" + obj.name);
            if (VerifyCanSpawn(obj))
            {
                Debug.Log("02/03 NetworkServer.Spawn : If In | obj :" + obj.name);
                SpawnObject(obj, ownerConnection);
                Debug.Log("03/03 NetworkServer.Spawn : If End | obj :" + obj.name);
            }
        }
